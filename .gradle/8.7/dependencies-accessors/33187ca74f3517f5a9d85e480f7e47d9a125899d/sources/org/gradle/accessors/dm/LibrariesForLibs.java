...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxNavigationUiKtxLibraryAccessors extends SubDependencyFactory {

        public AndroidxNavigationUiKtxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>z</b> with <b>androidx.navigation:navigation-ui-ktx)</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getZ() {
            return create("androidx.navigation.ui.ktx.z");
        }
